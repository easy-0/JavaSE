 ...
 * 		지역변수 - 메소드 또는 생성자 안에 선언도니 변수(매개변수도 지역변수이다.)
 * 				초기화 하지 않으면 compile error 발생! (반드시 초기화하기)
 * 				메소드 종료시 같이 소멸된다.
 * 3. 정적(static) 변수
 * 		static 붙은 멤버변수
...
//		//System.out.println("전역변수: " + globalNum); // static메모리에 아직 globalNum이 생성돼있지않음.
//
//		Var var1 = new Var();
//		System.out.println("전역변수: " + var1.globalNum);
//		
//		var1.printNum();
//		getAreaNum();
	}
