...
public class JavaLangClass03 {
	public static void main(String[] args) {
		String str1 = "abc";
		String str2 = "abc";
		String str3 = new String("abc"); // 같은 값이여도 새로 만들어짐
		...
		if(str1 == str3) {	
			System.out.println("str1 과 str3 는 같다.");
		}else {
			System.out.println("str1 과 str3 는 다르다.");
		}
		
		if(str1.equals(str2)) {	// 주소값이 아닌 값을 비교하게 오버라이딩돼있음
			System.out.println("str1 과 str2 는 같다.");
		}else {
			System.out.println("str1 과 str2 는 다르다.");
		}
